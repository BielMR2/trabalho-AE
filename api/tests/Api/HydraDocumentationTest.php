...
final class HydraDocumentationTest extends ApiTestCase
{
    ...
    public function hydraDocumentationIsValid(): void
    {
        ...
        self::assertContains('Establishment', $classNames, 'Establishment resource should be identified by shortName "Establishment"');
        self::assertContains('Evaluation', $classNames, 'Evaluation resource should be identified by shortName "Evaluation"');


        // Verify that resources DON'T use full type IRIs as class names
        self::assertNotContains('https://schema.org/Establishment', $classNames, 'Establishment should not use full IRI as class name');
        self::assertNotContains('https://schema.org/Evaluation', $classNames, 'Evaluation should not use full IRI as class name');
    }
